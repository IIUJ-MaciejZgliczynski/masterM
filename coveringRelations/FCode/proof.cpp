...
int main(int argc, char ** argv) {
	cout << "Begin reading Tsets " << endl;
	tset ts2_0 = getHsets("2_0");
	tset ts3_1 = getHsets("3_1");
	tset ts4_3 = getHsets("4_3");
	tset ts4_0 = getHsets("4_0");
	tset ts4_2 = getHsets("4_2");
	cout << "End of reading Tsets " << endl;
	cout.precision(20);
